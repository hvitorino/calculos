...
public class FinanciamentoDe21600Em55Vezes {
	...
	public void cenario() throws ParseException {
		...
		OpcoesFinanciamento opcoes = Financiar.valor(21600.00)
			.divididoEmParcelas(55)
			.comJuros(1.62, PeriodicidadeTaxa.MENSAL)
			.comIofDiario(0.0)
			.comIofAdicional(0.0)
			.contratadoEm("12/01/2016")
			.vencendoAPrimeiraParcelaEm("19/02/2016")
			.pronto();
